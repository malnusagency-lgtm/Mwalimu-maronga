  ...
  if (!product) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-center px-4">
        ...
        <p className="text-gray-500 mb-6">This material doesn&apos;t exist or has been removed.</p>
            ...
            <div className="relative h-[480px] rounded-3xl overflow-hidden shadow-2xl bg-gray-50">
              ...
              {product.pdfUrl && (
                <div className="absolute bottom-4 left-4">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold bg-indigo-600 text-white shadow-lg">
