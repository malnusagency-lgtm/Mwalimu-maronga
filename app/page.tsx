...
const stats = [
  { icon: GraduationCap, label: "KCSE Examiner", value: "Paper 102/3", color: "text-brand-gold-500" },
  { icon: Users, label: "Students Taught", value: "1,000+", color: "text-brand-green-500" },
  { icon: Award, label: "Schools", value: "3 Top Schools", color: "text-brand-gold-500" },
  { icon: BookOpen, label: "Materials", value: "5 PDFs", color: "text-brand-green-500" },
];

const credentials = [
  "KCSE Kiswahili Examiner (Paper 102/3)",
  "Taught at Ngenia Boys High School",
  "Taught at Mukoma High School",
  "Taught at Moi Girls' Nairobi",
            ...
            <div>
              ...
              >
                <span className="gold-badge mb-6 inline-flex">
                  ...
                  KCSE Examiner · Kiswahili Excellence
                </span>
      ...
      <SectionWrapper className="bg-gray-50">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <span className="green-badge mb-4 inline-flex">About Mwalimu Maronga</span>
            <h2 className="section-title mb-6">
              Teaching Kiswahili is{" "}
              <span className="text-gradient-green">more than a profession</span>
            </h2>
            <p className="text-gray-600 leading-relaxed mb-6">
              Victor Maronga is a dedicated Kiswahili teacher and certified KCSE examiner whose
              passion for the language extends far beyond the classroom. With experience at Ngenia
              Boys, Mukoma High School, and Moi Girls Nairobi, he has shaped hundreds of students
              into confident Kiswahili speakers and writers.
            </p>
            <p className="text-gray-600 leading-relaxed mb-8">
              As a published writer of <em>Isimu Jamii</em> and an educational actor, Mwalimu Maronga
              brings a creative and holistic approach to language education — making learning not just
              effective, but genuinely enjoyable.
            </p>
